...
describe('WaterjugriddleController', () => {
    ...
    beforeEach(async () => {
        ...
        const module: TestingModule = await Test.createTestingModule({
            ...
            providers: [
                { provide: WaterjugriddleService, useValue: mockService },
                {
        ...
        controller = module.get<WaterjugriddleController>(
            WaterjugriddleController,
        );
    });
    ...
    it('should calculate solution when no cached solution found', async () => {
        ...
        jest.spyOn(mockService, 'solveWaterJugProblem').mockReturnValueOnce(
            calculatedSolution,
        );
        expect(await controller.solve(reqBody)).toEqual({
